...
/**
 * Builder for the creation of {@link org.dbunit.dataset.xml.FlatXmlDataSet} instances.
 *
 ...
 * @since 2.4.7
 */
public final class BugFixedFlatXmlDataSetBuilder
{
    /**
     * Logger for this class
     */
    private static final Logger logger = LoggerFactory.getLogger(
        BugFixedFlatXmlDataSetBuilder.class);
     ...
     * Default constructor
     */
    public BugFixedFlatXmlDataSetBuilder()
    {
    }

    /**
     * Sets the flat XML input source from which the {@link org.dbunit.dataset.xml.FlatXmlDataSet} is to be built
     * @param inputSource The flat XML input as {@link InputSource}
     * @return The created {@link org.dbunit.dataset.xml.FlatXmlDataSet}
     ...
     * @return this
     */
    public BugFixedFlatXmlDataSetBuilder setMetaDataSet(IDataSet metaDataSet)
    {
     ...
     * @return this
     */
    public BugFixedFlatXmlDataSetBuilder setMetaDataSetFromDtd(Reader dtdReader) throws DataSetException, IOException
    {
     ...
     * @return this
     */
    public BugFixedFlatXmlDataSetBuilder setMetaDataSetFromDtd(InputStream dtdStream) throws DataSetException, IOException
    {
     ...
     * @return this
     */
    public BugFixedFlatXmlDataSetBuilder setDtdMetadata(boolean dtdMetadata) {
     ...
     * @return this
     */
    public BugFixedFlatXmlDataSetBuilder setColumnSensing(boolean columnSensing) {
     ...
     * @return this
     */
    public BugFixedFlatXmlDataSetBuilder setCaseSensitiveTableNames(boolean caseSensitiveTableNames) {
    ...
    protected FlatXmlProducer createProducer(InputSource inputSource)
    {
        ...
        if(this.metaDataSet!=null)
        {
            ...
            producer = new BugFixedFlatXmlProducer(inputSource, this.metaDataSet);
        }
        else
        {
            logger.debug("Creating FlatXmlProducer using the properties of this builder: {}", this);
            producer = new BugFixedFlatXmlProducer(
