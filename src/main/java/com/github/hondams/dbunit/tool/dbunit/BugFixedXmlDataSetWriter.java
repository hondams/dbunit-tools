 ...
 */
public class BugFixedXmlDataSetWriter implements IDataSetConsumer
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(
        BugFixedXmlDataSetWriter.class);
     ...
     * Can be null. See {@link XmlWriter#XmlWriter(java.io.OutputStream, String)}.
     * @throws java.io.UnsupportedEncodingException
     */
    public BugFixedXmlDataSetWriter(OutputStream outputStream, String encoding)
        throws UnsupportedEncodingException
    {
        _xmlWriter = new BugFixedXmlWriter(outputStream, encoding);
        _xmlWriter.enablePrettyPrint(true);
    }

    public BugFixedXmlDataSetWriter(Writer writer)
    {
        _xmlWriter = new BugFixedXmlWriter(writer);
        _xmlWriter.enablePrettyPrint(true);
    }

    public BugFixedXmlDataSetWriter(Writer writer, String encoding)
    {
        _xmlWriter = new BugFixedXmlWriter(writer, encoding);
        _xmlWriter.enablePrettyPrint(true);
    }
     ...
     * @param dataSet The {@link org.dbunit.dataset.IDataSet} to be written
